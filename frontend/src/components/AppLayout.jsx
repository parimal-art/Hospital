...
import { FiActivity, FiArchive, FiBell, FiBookOpen, FiBriefcase, FiClipboard, FiCreditCard, FiFileText, FiGrid, FiHome, FiMenu, FiSettings, FiUsers } from 'react-icons/fi';
...
const menuMap = {
  ...
  [ROLES.AUDITOR]: [
    ['/', 'Dashboard', <FiHome />], ['/reports', 'Reports', <FiGrid />], ['/ledgers', 'Ledgers', <FiBookOpen />], ['/transactions', 'Transactions', <FiCreditCard />], ['/patients', 'Patients', <FiActivity />], ['/audit-logs', 'Audit Logs', <FiClipboard />], ['/my-profile', 'My Profile', <FiUsers />]
  ]
};
