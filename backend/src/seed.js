...
const seed = async () => {
  ...
  await Promise.all([
    ...
    DailyIPDEntry.deleteMany(), Invoice.deleteMany(), Transaction.deleteMany(), DoctorAssignment.deleteMany(), Notification.deleteMany(), AuditLog.deleteMany(), DocumentUpload.deleteMany()
  ]);
